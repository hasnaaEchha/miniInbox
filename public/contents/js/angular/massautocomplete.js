...
.directive('massAutocomplete', ["$rootScope","$timeout", "$window", "$document", "$q", function ($rootScope,$timeout, $window, $document, $q) {
  'use strict';
  ...
  return {
    ...
    controller: ["$scope", function ($scope) {
      ...
      function set_selection(i) {
        ...
        $rootScope.idFacebook=selected.id;
        current_element.val({value:selected.value});
